      ...
      <div className="mx-auto min-w-fit border rounded-lg p-5 bg-slate-100">
        ...
        >
          ...
          <CollapsibleContent className="space-y-2">
            <div className="flex rounded-md border px-4 py-2 font-mono text-sm shadow-sm ">
              <Link className="p-2" to={"/casellario-alfanumerico"}><Button>1x3x3</Button></Link>
              <Link className="p-2" to={"/casellario_10"}><Button>10x3x3</Button></Link>
            </div>
          </CollapsibleContent>
        </Collapsible>
        <Collapsible
        ...
        >
          ...
          <CollapsibleContent className="space-y-2">
            ...
            <Link className="p-2" to={"/test"}><Button>test-paroliere-wip</Button></Link>
